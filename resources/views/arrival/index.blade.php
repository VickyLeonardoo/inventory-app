<x-app-layout>
    <x-slot name="header">
        <div class="flex flex-row justify-between items-center">
            ...
            <a href="{{ route('arrival.create') }}" class="font-bold py-4 px-6 bg-indigo-700 text-white rounded-full">
                Add New
            </a>
                        ...
                        <tr class="bg-gray-100">
                            ...
                            <td class="px-4 py-2 border border-gray-300">
                                <div class="flex space-x-2">
                                    ...
                                    <!-- Tombol Delete -->
                                    <form action="{{ route('arrival.destroy', $arrival->id) }}" method="POST" onsubmit="return confirm('Are you sure?');">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" 
