<x-app-layout>
    <x-slot name="header">
        <div class="flex flex-row justify-between items-center">
            ...
            <a href="{{ route('supplier.create') }}" class="font-bold py-4 px-6 bg-indigo-700 text-white rounded-full">
                Add New
            </a>
                ...
                <table id="example" class="display w-full border-collapse border border-gray-300 mt-4">
                    ...
                    <tbody>
                        ...
                        <tr class="bg-gray-100">
                            ...
                            <td class="px-4 py-2 border border-gray-300">{{ $supplier->email }}</td>
                            <td class="px-4 py-2 border border-gray-300">
                                <div class="flex space-x-2">
                                    ...
                                    <!-- Tombol Delete -->
                                    <form action="{{ route('supplier.destroy', $supplier->id) }}" method="POST" onsubmit="return confirm('Are you sure?');">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" 
